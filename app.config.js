...
export default () => {
  ...
  const config = {
    ...
    extra: {
      ...
      API_BACKUP_BASE_URL: process.env.EXPO_PUBLIC_API_BACKUP_BASE_URL ?? process.env.API_BASE_URL ?? '',
      ...
      IOS_GOOGLE_CLIENT_ID:
        process.env.EXPO_PUBLIC_IOS_GOOGLE_CLIENT_ID ?? process.env.EXPO_PUBLIC_GOOGLE_CLIENT_ID ?? '',
